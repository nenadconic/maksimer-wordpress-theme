...
?>
<section id="innholdsbygger-seksjon-<?php echo $innholdsbygger_teller; ?>" class="innholdsbygger-seksjon knapper<?php echo $padding; ?>" style="<?php echo $bakgrunn_farge . $tekst_farge; ?>">
