...
jQuery(function ($) {
  /**
    ...
    */
  $(document).on('click', '.sweet-variations .choose-variation', function (event) {
    event.preventDefault();
    var element = event.currentTarget; // Setup data attributes as const

    var attributes = $(element).data('variations'); // Remove potential other active item and set clicked to active
  ...
  $(document).on('click', '.sweet-variation-large .choose-variation', function (event) {
    event.preventDefault();
    var button = event.currentTarget; // Setup data attributes as const

    var attributes = $(button).data('variations');
    $.each(attributes, function (key, value) {
      // Update core WooCommerce select input matching clicked attribute variation
      $("#".concat(key)).val(value).change();
    });
  ...
  $('form.variations_form').on('show_variation', function (event, variation) {
    ...
    $.each(variation.attributes, function (key, value) {
      ...
      var singleVariation = $('.sweet-variations').find(".choose-variation[data-".concat(key, "=").concat(value, "]")); // Get image from the small sweet variation

      var termImage = $(singleVariation).data('term_image'); // Get the name from the small sweet variation

      var termName = $(singleVariation).find('.variant-name').text(); // Get the relevant sweet variation opener button

      var currentButton = $(".open-variations[data-".concat(key, "=\"true\"]")); // Replace image in the relevant sweet variation opener button
      ...
      $(currentButton).find('.button-name').html(termName); // Add class to the currently active small sweet variation

      $(singleVariation).addClass('active-option'); // Add to the cssChecks string

      cssChecks = "".concat(cssChecks, "[data-").concat(key, "=\"").concat(value, "\"]");
    }); // Get the relevant large sweet variation

    var singleVariationLarge = $(".choose-variation-large".concat(cssChecks)); // Add class to the relevant large sweet variation
  ...
  $(document).on('click', '.open-variations', function (event) {
    event.preventDefault();
    var element = event.currentTarget;
    var attribute = $(element).data('attribute');
    $(element).toggleClass('variations-open');
    $(element).closest('.single_variation_wrap').find(".sweet-variation-dropdown[data-attribute=\"".concat(attribute, "\"]")).slideToggle();
  });
  /**
    * Scroll to add to cart container on large variation select
    */

  $(document).on('click', '.choose-variation-large', function () {
